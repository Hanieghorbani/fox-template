...
export default function Landing() {
  return (
    <div className="header-bottom bg-primary container-primary flex sm: flex-col md:flex-row justify-between items-center pt-10 overflow-hidden relative" id="landing">
